    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_outside: cn(
          ...
          "dark:text-gray-500 dark:opacity-30"
        ),
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft className="h-4 w-4 dark:text-gray-100" {...props} />,
        IconRight: ({ ...props }) => <ChevronRight className="h-4 w-4 dark:text-gray-100" {...props} />,
        ...(props.components || {}),
      }}
      {...props}
    />
