...
export const enTranslations = {
  ...
  viewAttendanceRecords: "View attendance records filtered by time period",
  ...
  inactiveIncluded: "Inactive Included",
  reportConfigHeader: "Attendance Report",
  reportConfigDescription: "Generate detailed attendance reports with advanced filtering options",
